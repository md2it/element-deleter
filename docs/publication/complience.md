...
- `storage`
  Save tool preferences locally (language, toast duration, element labels, outline helper for picking nodes). Keep short-lived session state per tab. No data is uploaded or shared.
