...
var MESSAGES = {
  en: {
    ...
    surveyUsefulTitle: "Was this extension useful?",
    surveyAskLater: "Ask me later",
    surveyNeverAsk: "Never ask",
    surveyNo: "No",
    surveyYes: "Yes",
    surveySupportTitle: "Thank you. You can support the project",
    surveyLater: "Later",
  ...
  es: {
    ...
    surveyUsefulTitle: "¿Te resultó útil esta extensión?",
    surveyAskLater: "Pregúntame más tarde",
    surveyNeverAsk: "No volver a preguntar",
    surveyNo: "No",
    surveyYes: "Sí",
    surveySupportTitle: "Gracias. Puedes apoyar el proyecto",
  ...
  fr: {
    ...
    surveyUsefulTitle: "Cette extension vous a-t-elle été utile ?",
    surveyAskLater: "Me demander plus tard",
    surveyNeverAsk: "Ne plus demander",
    surveyNo: "Non",
    surveyYes: "Oui",
    surveySupportTitle: "Merci. Vous pouvez soutenir le projet",
  ...
  de: {
    ...
    surveyUsefulTitle: "War diese Erweiterung nützlich?",
    surveyAskLater: "Später fragen",
    surveyNeverAsk: "Nicht mehr fragen",
    surveyNo: "Nein",
    surveyYes: "Ja",
    surveySupportTitle: "Danke. Sie können das Projekt unterstützen",
    surveyLater: "Später",
  ...
  ru: {
    ...
    surveyUsefulTitle: "Расширение было полезным?",
    surveyAskLater: "Спросить позже",
    surveyNeverAsk: "Больше не спрашивать",
    surveyNo: "Нет",
    surveyYes: "Да",
    surveySupportTitle: "Спасибо. Вы можете поддержать проект",
    surveyLater: "Позже",
  ...
  zh_CN: {
    ...
    surveyUsefulTitle: "这个扩展对你有帮助吗？",
    surveyAskLater: "稍后再问",
    surveyNeverAsk: "不再询问",
    surveyNo: "没有",
    surveyYes: "有",
    surveySupportTitle: "谢谢。你可以支持这个项目",
    surveyLater: "稍后",
  ...
  ar: {
    ...
    surveyUsefulTitle: "هل كانت الإضافة مفيدة؟",
    surveyAskLater: "اسألني لاحقًا",
    surveyNeverAsk: "لا تسأل مرة أخرى",
    surveyNo: "لا",
    surveyYes: "نعم",
    surveySupportTitle: "شكرًا. يمكنك دعم المشروع",
    surveyLater: "لاحقًا",
