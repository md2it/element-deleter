...
var PANEL_POPUP_TABS = ["settings", "shortcuts", "info", "recommend"];
...
export { PANEL_POPUP_PAGE, PANEL_POPUP_ROOT_ID, PANEL_POPUP_HOST_ATTR, PANEL_POPUP_SESSION_TAB_KEY, PANEL_POPUP_TABS, PANEL_PAGE_CONFIG };
